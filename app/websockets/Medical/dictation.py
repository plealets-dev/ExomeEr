...
@router.websocket("/v2.0/medical/dictation")
                    ...
                    if transcription_result_english:
                        ...
                        if purpose == "MedicalDictation":
                            ...
                            if not tagged_context:
                                tagged_context = {'tags': "Unknown", 'text': transcription_result_english}
                            else:
                                tagged_context = {'tags': tagged_context, "text": transcription_result_english}
